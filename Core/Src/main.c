...
/* USER CODE BEGIN PFP */
static uint32_t Read_Ultrasonic_Distance(void);
...
//		  	  sprintf(sdk_handler.log_content,"Temperature: %d C, Humidity: %d%%\r\n", Temperature, Humidity);
//
...
//
//    htim4.Instance = TIM2;
//    htim4.Init.Prescaler = 83; // 1 microsecond resolution
